...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.RelayArchive())
	{
	...
	geminiRouter.Use(middleware.RelayArchive())
	{
	...
	geminiCompatibleRouter.Use(middleware.RelayArchive())
	{
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.RelayArchive(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.RelayArchive())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.RelayArchive(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.RelayArchive())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.RelayArchive(), middleware.Distribute())
	{
