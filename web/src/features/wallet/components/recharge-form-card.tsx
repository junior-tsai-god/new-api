...
function isLegacyPayPalHostedPaymentLink(value?: string): boolean {
...
export function RechargeFormCard({
  ...
  const redemptionLink = isLegacyPayPalHostedPaymentLink(topupLink)
    ? undefined
    : topupLink
          ...
          <div className='space-y-4 sm:space-y-6'>
            ...
            <div className='space-y-3'>
              ...
              <div className='flex flex-wrap gap-3'>
                {['payment-1', 'payment-2', 'payment-3'].map((key) => (
                    ...
                    {topupInfo?.pay_methods?.map((method) => {
                      ...
                      const button = (
                        <Button
                          ...
                          className='min-h-14 min-w-0 justify-start gap-2 rounded-2xl px-3 py-2 text-left'
                        >
