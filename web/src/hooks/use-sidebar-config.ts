...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/model-status': { section: 'console', module: 'detail' },
  '/model-catalog/catalog': { section: 'console', module: 'detail' },
  '/model-catalog/status': { section: 'console', module: 'detail' },
  '/keys': { section: 'console', module: 'token' },
  '/usage-logs': { section: 'console', module: 'log' },
  '/usage-logs/common': { section: 'console', module: 'log' },
  '/usage-logs/archive': { section: 'console', module: 'log' },
